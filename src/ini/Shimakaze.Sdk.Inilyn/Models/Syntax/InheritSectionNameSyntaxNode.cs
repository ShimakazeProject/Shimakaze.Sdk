...
/// <summary>
/// 表示一个 INI 继承节名称的语法节点（如 [Section:Base] 中的 Base 部分）。
/// </summary>
public sealed class InheritSectionNameSyntaxNode : SyntaxNode
{
    /// <summary>
    /// 初始化一个新的 <see cref="InheritSectionNameSyntaxNode"/> 实例。
    /// </summary>
    ...
    /// 对于 <see cref="InheritSectionNameSyntaxNode"/>，始终返回 true。
    /// </summary>
