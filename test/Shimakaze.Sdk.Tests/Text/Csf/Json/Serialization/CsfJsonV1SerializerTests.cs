...
public class CsfJsonV1SerializerTests
{
    ...
    private const string OutputDeserializeJsonFile1 = "DeserializeTest1.v1.csf.json";
    private const string OutputDeserializeCsfFile2 = "DeserializeTest2.v1.csf";
    private const string OutputDeserializeJsonFile2 = "DeserializeTest2.v1.csf.json";
    private const string OutputSerializeFile1 = "SerializeTest1.v1.csf.json";
    private const string OutputSerializeFile2 = "SerializeTest2.v1.csf.json";
