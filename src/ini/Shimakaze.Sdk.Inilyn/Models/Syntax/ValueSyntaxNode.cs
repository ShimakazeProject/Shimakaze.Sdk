...
/// <summary>
/// 表示一个 INI 值（Value）的语法节点。
/// 该节点通常出现在键值对中，如 Key=Value 中的 Value 部分。
/// </summary>
public sealed class ValueSyntaxNode : SyntaxNode
{
    /// <summary>
    /// 初始化一个新的 <see cref="ValueSyntaxNode"/> 实例。
    /// </summary>
    ...
    /// 对于 <see cref="ValueSyntaxNode"/>，始终返回 true。
    /// </summary>
